...
<style>
body{width:100%;height:100%;overflow:hidden;background:url({{asset('/admin/images/pc_loginBg.jpg')}}) no-repeat;background-size:cover;position:absolute;}
</style>
<script src="{{asset('admin/js/jquery.js')}}"></script>
<script src="{{asset('admin/js/Particleground.js')}}"></script>
<script>
$(document).ready(function() {
  ...
  $(".loginform input[type='button']").click(function(){
	  ...
	  location.href="{{asset('admin/index')}}";
	  });
});
</script>
