 ...
 <div class="wrap">
  ...
  <table class="list-style Interlaced">
   ...
   <tr>
    ...
    <td class="center">
     <a href="{{asset('admin/user/replymessage')}}" class="inline-block" title="回复"><img src="{{asset('admin/images/icon_title.gif')}}"/></a>
     <a class="inline-block" title="移除" onclick="javaScript:confirm('您确定要删除吗？')"><img src="{{asset('admin/images/icon_drop.gif')}}"/></a>
    </td>
   </tr>
  </table>
  <!-- BatchOperation -->
