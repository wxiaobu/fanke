...
<body>
 <div class="wrap">
  <div class="page-title">
    ...
    <span class="modular fr"><a href="{{asset('admin/user/adduserrank')}}" class="pt-link-btn">+添加会员等级</a></span>
  </div>
  <table class="list-style Interlaced">
   ...
   <tr>
    <td>
     <img src="{{asset('admin/images/user_02.png')}}"/>
    ...
    <td class="center">
     <a class="block" onclick="javaScript:confirm('您确定要删除吗？')">
      <img src="{{asset('admin/images/icon_drop.gif')}}"/>
     </a>
    </td>
   </tr>
   <tr>
    <td>
     <img src="{{asset('admin/images/user_01.png')}}"/>
