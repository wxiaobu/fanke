...
<body>
 <div class="wrap">
  ...
  <div class="operate">
   <form>
    <img src="{{asset('admin/images/icon_search.gif')}}"/>
  ...
  <table class="list-style Interlaced">
   ...
   <tr>
    <td>
     <input type="checkbox"/>
     <a href="{{asset('admin/order/detail')}}">2015041803225</a>
    </td>
    <td class="center">
    ...
    <td class="center">
     <a href="{{asset('admin/order/detail')}}" class="inline-block" title="查看订单"><img src="{{asset('admin/images/icon_view.gif')}}"/></a>
     <a class="inline-block" title="删除订单" onclick="javaScript:confirm('您确定要删除吗？')"><img src="{{asset('admin/images/icon_trash.gif')}}"/></a>
    </td>
   </tr>
  </table>
  <!-- BatchOperation -->
